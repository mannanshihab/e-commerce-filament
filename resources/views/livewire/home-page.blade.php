<div>
        ...
        <div class="py-20 mx-auto">
            <div class="text-center ">
                <div class="relative flex flex-col items-center">
                    <div class="w-85">
                        <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">Start your journey with <span class="text-blue-600">SliceTech</span></h1>
                    ...
                    <div class="flex w-85 mt-2 mb-6 overflow-hidden rounded">
                    <!-- Buttons -->
    ...
    <section>
        ...
        <div class="max-w-[85rem] px-4 sm:px-6 lg:px-8 mx-auto">
            ...
            <a class="group flex flex-col bg-white border shadow-sm rounded-xl hover:shadow-md transition dark:bg-slate-900 dark:border-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" wire:key = "{{ $category -> id}}" href="#">
