          ...
          <div class="">
            ...
            <div class="px-6 pb-6 mt-6">
                ...
                <div class="relative flex flex-row w-full h-10 mt-6 bg-transparent rounded-lg">    
                    @foreach ($product->ProductSpecification as $productSpac) 
                       <div class="border-blue-300 m-2">
                          {{ $productSpac->name }} : {{ $productSpac->value }}
                       </div>
                    @endforeach
                </div>
            </div>
          ...
          <div class="lg:pl-20">
            ...
            <div class="w-32 mb-8 ">
              ...
              <div class="relative flex flex-row w-full h-10 mt-6 bg-transparent rounded-lg">
                ...
                <input type="number" wire:model='quantity' readonly class="flex items-center w-full font-semibold text-center text-md " placeholder="1">
