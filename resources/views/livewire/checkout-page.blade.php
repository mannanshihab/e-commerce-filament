			...
			<div class="md:col-span-12 lg:col-span-4 col-span-12">
				...
				<div class="bg-white mt-4 rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
					...
					<ul class="divide-y divide-gray-200 dark:divide-gray-700" role="list">
						@foreach($cart_items as $cart_items_summary)
							<li class="py-3 sm:py-4" wire:key="{{ $cart_items_summary['product_id'] }}">
								<div class="flex items-center">
									<div class="flex-shrink-0">
										<img class="w-12 h-12 rounded-full" src="{{ url('storage', $cart_items_summary['image']) }}" alt="{{$cart_items_summary['name']}}">
										</img>
									</div>
									<div class="flex-1 min-w-0 ms-4">
										<p class="text-sm font-medium text-gray-900 truncate dark:text-white">
											{{$cart_items_summary['name']}}
										</p>
